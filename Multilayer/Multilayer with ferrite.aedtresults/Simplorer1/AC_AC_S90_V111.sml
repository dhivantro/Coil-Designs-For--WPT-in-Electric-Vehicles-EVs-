...
MODEL MaxwellData7_19 Mx_SS1 Rx_in1_src:= net_7 , Rx_in2_src:= net_7 , Rx_in3_src:= net_7 , Tx_in1_src:= net_11 , Tx_in2_src:= net_11 , Tx_in3_src:= net_11 , Rx_in1_snk:= net_10 , Rx_in2_snk:= net_10 , Rx_in3_snk:= net_10 , Tx_in1_snk:= net_13 , Tx_in2_snk:= net_13 , Tx_in3_snk:= net_13 (); 
